                ...
                <div class="container-fluid">
                    <router-link to="/">
                        <a class="navbar-brand" href="/">
                            <img src="../../assets/images/logo-icon.png" style="width: 100px;" alt="">
                        </a>
                    </router-link>
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <router-link to="/dat-phong">
                                    <a class="nav-link" href="/dat-phong"><i class="fa-solid fa-person-booth me-2"></i>Đặt Phòng</a>
                                </router-link>
                            </li>
                            <li class="nav-item">
                                <router-link to="/tim-loai-phong">
                                    <a class="nav-link" href="/tim-loai-phong"><i class="fa-solid fa-person-shelter me-2"></i>Loại Phòng</a>
                                </router-link>
                            </li>
                            <li class="nav-item">
                                <router-link to="/danh-sach-phong">
                                    <a class="nav-link" href="/danh-sach-phong"><i class="fa-solid fa-hotel me-2"></i>Phòng</a>
                                </router-link>
                            </li>
                            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-solid fa-newspaper me-2"></i>
                                    Bài Viết
                                </a>
                        ...
                        <template v-if="is_check == false">
                            <form class="d-flex">
                                <router-link to="/khach-hang/dang-nhap">
                                    <button class="btn btn-dark me-2 radius-30 px-4" type="button"><i class="bx bx-lock"></i> Login</button>
                                </router-link>
                                <router-link to="/khach-hang/dang-ky">
                                    <button class="btn btn-light me-2 radius-30 px-4" type="button"><i class="bx bx-user"></i>
                                        Register</button>
                                </router-link>
                                <router-link to="/admin/dang-nhap">
                                    <button class="btn btn-success radius-30 px-4" type="button"><i class="bx bx-user"></i>
                                        Admin</button>
                                </router-link>
                            </form>
                        </template>
                        <template v-else>
                            <div class="user-box dropdown">
                                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="https://t3.ftcdn.net/jpg/05/53/79/60/360_F_553796090_XHrE6R9jwmBJUMo9HKl41hyHJ5gqt9oz.jpg" class="user-img" alt="user avatar">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a v-on:click="dangXuat()" class="dropdown-item"><i class='bx bx-log-out-circle'></i><span>Đăng Xuất</span></a>
                                    </li>
                                    <li><a v-on:click="dangXuatAll()" class="dropdown-item"><i class='bx bx-log-out-circle'></i><span>Đăng Xuất Tất Cả</span></a>
                                    </li>
                                </ul>
                            </div>
                        </template>
...
export default {
    ...
    methods: {
        ...
        dangXuatAll() {
            axios.get('http://127.0.0.1:8000/api/khach-hang/dang-xuat-all', {
                    headers: {
                        Authorization: 'Bearer ' + localStorage.getItem("token_khachhang")
                    }
                })
                ...
                .catch((error) => {
                    ...
                    Swal.fire({
                        title: "Lỗi!",
                        text: "Có lỗi xảy ra khi đăng xuất tất cả.",
                        icon: "error"
                    });
                });
        }
